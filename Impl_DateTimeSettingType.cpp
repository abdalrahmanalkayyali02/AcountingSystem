...
int DateTimeType::get_Day() const {
    return day; 
}
...
int DateTimeType::get_Month() const  {
    return month;
} 
...
int DateTimeType::get_Year() const {
    return year;
} 
...
int DateTimeType::get_Hour() const {
    return hour;
}
...
int DateTimeType::get_Minute() const {
    return minute;
}
...
int DateTimeType::get_Secound() const {
    return secound;
}
